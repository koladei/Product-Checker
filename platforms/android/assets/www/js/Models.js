...
//                        console.log(e.data.Message);
        ...
        var helperPage = baseDomain + "/product-checker/_js/postMessageHelper.html#" + document.location.origin;
...
//                console.log(Models.CallbackArray);
        ...
        function updateItem(parameters) {
            ...
            if (typeof messageWindow !== 'undefined') {
                ...
                var url = baseDomain + '/product-checker/_api/' + parameters.Entity;
                var ajax = {
                    type: "POST",
                    url: url,
        ...
        function getItems(options) {
            ...
            var url = baseDomain + '/product-checker/_api/' + settings.Entity + '?' + query + '&$responsePrefix=' + entityCallbackName + '(&$responseSuffix=);';
            //            console.log(url);
            $.ajax({
                crossDomain: true,
                url: url,
